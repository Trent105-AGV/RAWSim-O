...
public class Program
{
    ...
    private static void MarkTagFinished(string statisticsPath, string instance, string setting, string config, string seed, string tag)
    {
        ...
        var success = false; var tries = 0; var rand = new Random(); var fileName = Path.Combine(statisticsPath, TAG_FILE);
        do
        {
            try
            {
                ...
                // Try it
                tries++; var fileExists = File.Exists(fileName);
    ...
    public static void Main(string[] args)
    {
        ...
        var logAction = (string message) => { LogLine(message); };
        ...
        var statisticsFolder = instance.Name + "-" + instance.SettingConfig.Name + "-" + instance.ControllerConfig.Name + "-" + instance.SettingConfig.Seed;
