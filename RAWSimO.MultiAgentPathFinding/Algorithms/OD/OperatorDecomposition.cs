...
public class OperatorDecomposition : AStarBase, IndependenceDetection.LowLevelSolver
{
    ...
    /// </summary>
    public readonly List<Agent> NodeCreatedByAgent;

    /// <summary>
    /// The mapping of generated nodes to the 2D Edge
    /// null = Wait Edge
    /// </summary>
    public readonly List<int> NodeStepNode;
    ...
    /// The h values
    /// </summary>
    private readonly List<double> _hValues;

    /// <summary>
    /// The g values
    /// </summary>
    private readonly List<double> _gValues;
    ...
    /// </summary>
    private readonly double _lengthOfAWaitStep;
    ...
    /// </summary>
    private readonly int _maxNodeCountPerAgent;

    /// <summary>
    /// Use final reservations
    /// </summary>
    public readonly bool _useFinalReservations;

    /// <summary>
    /// The length of a wait step
    /// </summary>
    public readonly double _lengthOfAWindow;
        ...
        : base(0, -1)
    {
        ...
        _maxNodeCountPerAgent = maxNodeCountPerAgent;
        _useFinalReservations = useFinalReservations;
        _graph = graph;
        _stopSearch = false;
        NodeBackpointerId = [];
        NodeCreatedByAgent = [];
    ...
    public void Init(double currentTime, List<Agent> allAgents)
    {
        ...
        {
            _nodeGenerator.Add(agent.ID, new SpaceTimeAStarSteper(_graph, _lengthOfAWaitStep, agent, new ReverseResumableAStar(_graph, agent, agent.Physics, agent.DestinationNode)));
        }
    }
    ...
    public override double h(int node)
    {
        ...
        {
            var agent = NodeCreatedByAgent[node];
