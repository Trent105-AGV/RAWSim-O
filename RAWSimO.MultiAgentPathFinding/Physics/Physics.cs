...
public class Physics
{
    ...
    /// </summary>
    private readonly double _timeToBreakFromFullSpeedToZero;

    /// <summary>
    /// The time needed to break from full speed to zero
    /// </summary>
    private readonly double _timeToAccelerateFromZeroToFullSpeed;

    /// <summary>
    /// The travel distance needed to break from full speed to zero
    /// </summary>
    private readonly double _travelDistanceFromFullSpeedToZero;
    ...
    public double getOrientationAfterTimeStep(double currentOrientation, double targetOrientation, double timeSpan)
    {
        ...
        var orientationChange = timeSpan * (PI2 / TurnSpeed);
        var orientationDifference = _getOrientationDifference(currentOrientation, targetOrientation);
