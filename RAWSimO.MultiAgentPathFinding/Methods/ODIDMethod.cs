...
public class ODIDMethod : PathFinder
{
    ...
    /// </summary>
    private readonly IndependenceDetection _independenceDetection;
    ...
    {
        _independenceDetection.LowLevSolver ??= new OperatorDecomposition(Graph, LengthOfAWaitStep, LengthOfAWindow, MaxNodeCountPerAgent, UseFinalReservations);
