...
public class DisjointIntervalTree
{
    ...
    /// </summary>
    protected readonly List<double> _intervalStart;

    /// <summary>
    /// The list of interval ending points
    /// </summary>
    protected readonly List<double> _intervalEnds;

    /// <summary>
    /// The list of the agentID reserving this interval
    /// </summary>
    protected readonly List<int> _intervalAgentId;

    /// <summary>
    /// The list of the agentID reserving this interval
    /// </summary>
    protected readonly List<int> _intervalPrio;
    ...
    public DisjointIntervalTree(bool storeAgentIds, bool storePrios)
    {
        _intervalStart = [];
        _intervalEnds = [];
        _intervalAgentId = storeAgentIds ? [] : null;
        _intervalPrio = storePrios ? [] : null;
    }
    ...
    public virtual void Add(double start, double end, int agentId = -1, int prio = -1)
    {
        ...
        var senselesseInterval = end - start < ReservationTable.TOLERANCE;
        ...
        if (!_intersectionFree(start, end, out insertionIndex))
        {
            ...
            sb.Append("Senseless interval evaluated to: " + senselesseInterval + "\n");
            for (var i = 0; i < _intervalStart.Count; i++)
    ...
    /// The count.
    /// </value>
    public virtual int Count => _intervalStart.Count;
