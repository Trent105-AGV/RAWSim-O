...
public class ConflictTree
{
    ...
    public class Node
    {
        ...
        /// </summary>
        public readonly ReservationTable.Interval IntervalConstraint;

        /// <summary>
        /// The solution of the node.
        /// AgentId => Path
        /// </summary>
        private readonly Dictionary<int, Path> _solution;

        /// <summary>
        /// The reservations of the agent.
        /// AgentId => Reservation
        /// </summary>
        private readonly Dictionary<int, List<ReservationTable.Interval>> _reservation;
        ...
        /// <param name="agentID">The agent identifier.</param>
        /// <returns></returns>
        public IEnumerable<Node> getConstraints(int agentId)
        {
        ...
        /// </summary>
        public class ConstraintCollector : IEnumerable<Node>
        {
            ...
            /// </summary>
            public class ConstraintEnumerator : IEnumerator<Node>
            {
