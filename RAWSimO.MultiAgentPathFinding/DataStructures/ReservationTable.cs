...
public class ReservationTable
{
    ...
    /// </summary>
    public static readonly double TOLERANCE = 0.000000000001;
    ...
    /// The intervals
    /// </summary>
    protected readonly DisjointIntervalTree[] _intervallTrees;

    /// <summary>
    /// The touched nodes
    /// </summary>
    protected readonly HashSet<int> _touchedNodes;

    /// <summary>
    /// The touched nodes
    /// </summary>
    protected readonly bool _storeAgentIds;

    /// <summary>
    /// The touched nodes
    /// </summary>
    protected readonly bool _storePrios;
    ...
    {
        Add(interval.Node, interval.Start, interval.End, agentId, prio);
    }
    ...
    public List<Interval> CreateIntervals(double startIntervalAt, double startDrivingAt, double currentSpeed, Physic.Physics physics, int startNode, int destinationNode, bool addIntervalToInfinity)
    {
        ...
        var valid = GetCheckPointNodes(startDrivingAt, currentSpeed, physics, startNode, destinationNode, out checkPointNodes, out checkPointTimes);
    ...
    public Interval GetOverlappingInterval(Interval interval)
    {
        ...
        return new Interval(interval.Node, start, end);
    }
