    ...
    : IEnumerable<FibonacciHeapHeapCell<TPriority, TValue>>
{
    ...
    /// first cell
    /// </summary>
    private FibonacciHeapHeapCell<TPriority, TValue> first;

    /// <summary>
    /// last cell
    /// </summary>
    private FibonacciHeapHeapCell<TPriority, TValue> last;

    /// <summary>
    /// constructor
    /// </summary>
    public FibonacciHeapHeapCell<TPriority, TValue> First => first;
    ...
    : IEnumerable<KeyValuePair<TPriority, TValue>>
{
    ...
    /// list of nodes
    /// </summary>
    private readonly FibonacciHeapHeapLinkedList<TPriority, TValue> nodes;

    /// <summary>
    /// next node
    /// </summary>
    private FibonacciHeapHeapCell<TPriority, TValue> next;
    /// <summary>
    /// Used to control the direction of the heap, set to 1 if the Heap is increasing, -1 if it's decreasing
    /// </summary>
    private readonly short DirectionMultiplier;  
    /// <summary>
    /// We use the approach to avoid unnessecary branches
    /// </summary>
    private readonly Dictionary<int, FibonacciHeapHeapCell<TPriority, TValue>> degreeToNode;
    /// <summary>
    /// comparison function
    /// </summary>
    ...
    /// </summary>
    public Func<TPriority, TPriority, int> PriorityComparison => priorityComparsion;
    ...
    public FibonacciHeapHeapCell<TPriority, TValue> Top => next;
