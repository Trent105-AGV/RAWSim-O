...
public class BestCandidateSelector
{
    ...
    /// </summary>
    private readonly double[] _bestScores;
    /// <summary>
    /// Returns the current best scores per scoring function.
    /// </summary>
    public double[] BestScores => _bestScores;
    ...
    private bool ReassessMax()
    {
        ...
        for (var scorerIndex = 0; scorerIndex < _scorers.Length; scorerIndex++)
        {
            ...
            if (_bestScores[scorerIndex] < _currentValue[scorerIndex] || !_assigned)
            {
