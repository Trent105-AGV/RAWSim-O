...
public class MultiKeyDictionary<TValue>
{
    ...
    public TValue this[params object[] index] { get => _storage[index];
    ...
    /// </summary>
    public IEnumerable<object[]> Keys => _storage.Keys;
...
public class SymmetricKeyDictionary<TKeys, TValue>
{
    ...
    /// The actual storage.
    /// </summary>
    private readonly MultiKeyDictionary<TValue> _storage;
    /// <summary>
    /// All keys.
    /// </summary>
    private readonly HashSet<Tuple<TKeys, TKeys>> _keys;
    /// <summary>
    /// Creates a new instance of the dictionary.
    /// </summary>
    public SymmetricKeyDictionary() { _storage = new MultiKeyDictionary<TValue>(); _keys = []; }
    /// <summary>
    /// Gets or sets the value with the given index.
    /// </summary>
    ...
    public TValue this[TKeys key1, TKeys key2]
    {
        get
        {
            if (_storage.ContainsKey(key1, key2)) return _storage[key1, key2];
            return _storage[key2, key1];
        }
    ...
    /// </summary>
    public IEnumerable<Tuple<TKeys, TKeys>> KeysCombined => _keys;
...
public class MultiKeyDictionary<K1, K2, TValue>
{
    ...
    /// <param name="key2">The second key defining the index.</param>
    /// <returns>The value at this index.</returns>
    public TValue this[K1 key1, K2 key2] { get => _storage[key1, key2];
...
public class MultiKeyDictionary<K1, K2, K3, TValue>
{
    ...
    /// <returns>The value at this index.</returns>
    public TValue this[K1 key1, K2 key2, K3 key3] { get => _storage[key1, key2, key3];
