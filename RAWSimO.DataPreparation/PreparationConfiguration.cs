    ...
    public PreparationConfiguration()
    {
        ...
        [
            new()
            {
                ...
                [
                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundlesPlaced, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundlesHandled, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration { DataType = PlotDataContentType.OrdersPlaced, Axis = PlotAxis.Y2 },
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrdersHandled, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundleThroughputTimeAvg, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundleTurnoverTimeAvg, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderThroughputTimeAvg, Axis = PlotAxis.Y2 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderTurnoverTimeAvg, Axis = PlotAxis.Y2 }
                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InventoryLevel, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.DistanceTraveled, Axis = PlotAxis.Y2 }
                    ],
                    ...
                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.PodsHandledAtIS, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.PodsHandledAtOS, Axis = PlotAxis.Y1 }
                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundlesBacklogLevel, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrdersBacklogLevel, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderLatenessAvg, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.LateOrderFractional, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundleThroughputAgeAverage, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundleTurnoverAgeAverage, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderThroughputAgeAverage, Axis = PlotAxis.Y2 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderTurnoverAgeAverage, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.SKUCountContained, Axis = PlotAxis.Y2 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.BundleFrequencyAverage, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OrderFrequencyAverage, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvCombinedTotal, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvSpeedTotal, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvUtilityTotal, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvCombinedAvgRank, Axis = PlotAxis.Y2 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvSpeedAvgRank, Axis = PlotAxis.Y2 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.InvUtilityAvgRank, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationIdleTime, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationIdleTime, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationActiveTime, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationActiveTime, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationOpenWork, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationRequests, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationOpenWork, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationRequests, Axis = PlotAxis.Y1 }
                    ...
                    [
                        ...
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.TaskBotCounts, Axis = PlotAxis.Y2 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.LastMileTripTimeOStation, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.LastMileTripTimeIStation, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationBundlesStored, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationItemsPicked, Axis = PlotAxis.Y2 }
                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationBundlePileon, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationItemPileon, Axis = PlotAxis.Y2 }
                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.IStationsActive, Axis = PlotAxis.Y1 },

                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.OStationsActive, Axis = PlotAxis.Y1 }

                    ],

                    [
                        new SinglePlotConfiguration
                            { DataType = PlotDataContentType.ControllerRuntimes, Axis = PlotAxis.Y1 }
...
public class SinglePlotConfiguration
{
    ...
    /// </summary>
    private static readonly Dictionary<PlotDataContentType, string> _descriptions = new()
    {
    ...
    /// </summary>
    private static readonly Dictionary<PlotDataContentType, string> _unitDescriptions = new()
    {
