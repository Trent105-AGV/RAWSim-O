...
public class FootprintScatterProcessor
{
    ...
    /// </summary>
    public static readonly List<FootprintScatterPlotData> DEFAULT_UNGROUPED_SCATTERPLOT_DATA =
    [
    ...
    /// </summary>
    public static readonly List<FootprintScatterPlotData> DEFAULT_GROUPINGS_SCATTERPLOT_DATA =
    [
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.OrderThroughputTimeAvg,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemPileOneAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRate,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemPileOneAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemPileOneAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.OrderThroughputTimeAvg,
            YAxis = FootprintDatapoint.FootPrintEntry.OrderThroughputRate
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.OrderTurnoverTimeAvg,
            YAxis = FootprintDatapoint.FootPrintEntry.OrderThroughputRate
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.OrdersHandled,
            YAxis = FootprintDatapoint.FootPrintEntry.BundlesHandled
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TripDistance,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemPileOneAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.LateOrdersFractional,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.OrderLatenessAvg,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.LateOrdersFractional,
            YAxis = FootprintDatapoint.FootPrintEntry.OrderLatenessAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore,
            YAxis = FootprintDatapoint.FootPrintEntry.OrderOffsetAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.ISIdleTimeAvg,
            YAxis = FootprintDatapoint.FootPrintEntry.OSIdleTimeAvg
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TimingDecisionsOverall,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRate
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.InvCombinedAvgRank,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TripDistance, YAxis = FootprintDatapoint.FootPrintEntry.TripTime
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TripDistance,
            YAxis = FootprintDatapoint.FootPrintEntry.TripTimeWithoutQueueing
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TimeMoving, YAxis = FootprintDatapoint.FootPrintEntry.TimeQueueing
        },
        new FootprintScatterPlotData
        {
            XAxis = FootprintDatapoint.FootPrintEntry.TimeQueueing,
            YAxis = FootprintDatapoint.FootPrintEntry.ItemThroughputRateScore
        },
        new FootprintScatterPlotData
        {
    ...
    /// </summary>
    public static readonly List<Tuple<List<FootprintDatapoint.FootPrintEntry>, string>> DEFAULT_GROUPINGS =
    [
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.Instance],
            "scatterplotsinstances"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.BotsPerOStation],
            "scatterplotsostationbots"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.NOStations],
            "scatterplotsostations"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.PP],
            "scatterplotsmethodspp"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.TA],
            "scatterplotsmethodsta"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.RB],
            "scatterplotsmethodsrb"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.IS],
            "scatterplotsmethodsis"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.PS],
            "scatterplotsmethodsps"),
        new Tuple<List<FootprintDatapoint.FootPrintEntry>, string>(
            [FootprintDatapoint.FootPrintEntry.OB],
            "scatterplotsmethodsob")
    ];
    ...
    /// </summary>
    public string FootprintFile { get; }
    /// <summary>
    ...
    /// </summary>
    private List<FootprintDatapoint> _datapoints = [];
        ...
        List<FootprintDatapoint.FootPrintEntry> groupBy)
    {
        ...
        var datColumns = new Dictionary<FootprintDatapoint.FootPrintEntry, int>();
        var currentIndex = 0;
        ...
        var singleDatFile = basename + ".dat";
        ...
        var dataGroups =
            ...
            groupBy.Any() ?
                ...
                null;
        LogLine("Found " + (dataGroups?.Count ?? 1) + " group(s)!");
        // Write dat file(s)
        if (dataGroups != null)
        {
            ...
            {
                using (var sw = new StreamWriter(Path.Combine(OutputDirectory, group.Value)))
                {
                    // Write header
                    sw.Write(IOConstants.GNU_PLOT_COMMENT_LINE + IOConstants.GNU_PLOT_VALUE_SPLIT.ToString());
        ...
        else
        {
            ...
            using (var sw = new StreamWriter(Path.Combine(OutputDirectory, singleDatFile)))
            {
                // Write header
                sw.Write(IOConstants.GNU_PLOT_COMMENT_LINE + IOConstants.GNU_PLOT_VALUE_SPLIT.ToString());
                foreach (var entry in datColumns.OrderBy(c => c.Value))
        ...
        var plotScript = basename + ".gp";
        using (var sw = new StreamWriter(Path.Combine(OutputDirectory, plotScript)))
        {
            sw.WriteLine("reset");
            ...
            var colorDefinition = DataProcessor.GenerateLineStyleScriptCodeWithPoints();
            var colorCount = colorDefinition.Length - colorDefinition.Replace(IOConstants.LINE_TERMINATOR, string.Empty).Length - 1;
        ...
        var commandScript = basename + ".cmd";
        using (var sw = new StreamWriter(Path.Combine(OutputDirectory, commandScript)))
