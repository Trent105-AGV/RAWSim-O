...
public class SimulationVisualizer
{
    ...
    private readonly SimulationAnimation2D _animationControl2D;
    private readonly SimulationAnimation3D _animationControl3D;
    private readonly SimulationInfoManager _infoControl;
    private readonly Func<bool> _getDrawMode3D;
    private readonly Action<double> _setUpdateRate;
    private double _updateRate;
    private readonly Action<double> _updateTime;
    private Action<string> _logger;
    private readonly Action _finishCallback;
    private readonly Instance _simulationWorld;
    private readonly ManualResetEvent[] _pausedMutex = new ManualResetEvent[] { new ManualResetEvent(false) };
