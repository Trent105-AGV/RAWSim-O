...
public class SimulationAnimation2D : SimulationAnimation
{
    ...
    protected readonly double DEFAULT_TRANSFORMATION_FACTOR = 40;
    ...
    protected readonly SimulationInfoManager _infoControl;
    ...
    public override void Init()
    {
        ...
        {
            var botVisual = new SimulationVisualBot2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
        ...
        {
            var podVisual = new SimulationVisualPod2D(v, _config.DetailLevel, _transformer, strokeThickness, _heatModeEnabled, _elementClickAction, this);
        ...
        {
            var iStationVisual = new SimulationVisualInputStation2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
        ...
        {
            var oStationVisual = new SimulationVisualOutputStation2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
        ...
        {
            var elevatorEntranceVisual = new SimulationVisualElevatorEntrance2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
        ...
        if (_config.DetailLevel >= DetailLevel.Debug)
        {
            ...
            if (_config.DetailLevel >= DetailLevel.Full)
            {
                ...
                {
                    var waypointVisual = new SimulationVisualWaypoint2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
            ...
            {
                var guardVisual = new SimulationVisualGuard2D(v, _config.DetailLevel, _transformer, strokeThickness, _elementClickAction, this);
