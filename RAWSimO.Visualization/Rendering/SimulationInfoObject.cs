...
public abstract class SimulationInfoObject
{
    ...
    protected double StrokeThicknessFocused => 5 * ManagedVisual2D.StrokeThicknessReference;
...
public class SimulationInfoInstance : SimulationInfoObject
{
    ...
    private readonly Brush _colorStationActive = Brushes.LightGreen;
    private readonly Brush _colorStationInactive = Brushes.MediumBlue;
    private readonly Brush _colorStationBlocked = Brushes.Red;
    private readonly Brush _colorStationFree = Brushes.LightGreen;
...
public class SimulationInfoBot : SimulationInfoObject
{
    ...
    public override void InfoPanelUpdate()
    {
        ...
        var currentWP = _bot.GetInfoCurrentWaypoint(); var destinationWP = _bot.GetInfoDestinationWaypoint(); var goalWP = _bot.GetInfoGoalWaypoint();
