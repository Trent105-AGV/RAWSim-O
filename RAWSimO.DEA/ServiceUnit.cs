...
public class ServiceUnit
{
    ...
    /// </summary>
    private readonly List<Tuple<FootprintDatapoint.FootPrintEntry, string>> _idents;
    ...
    public string Ident
    {
        ...
        {
            if (field == null)
                field = string.Join(DELIMITER, _idents.Select(i => i.Item2));
            return field;
        }
    } = null;
    ...
    /// The idents representing the service unit.
    /// </summary>
    public IEnumerable<Tuple<FootprintDatapoint.FootPrintEntry, string>> Idents => _idents;
