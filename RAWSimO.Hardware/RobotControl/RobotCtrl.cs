...
public class RobotCtrl
{
    ...
    /// </summary>
    public readonly RobotState State;
    /// <summary>
    ...
    /// </summary>
    private readonly int _pickupTime = (int)Math.Round(TimeSpan.FromSeconds(8).TotalMilliseconds);
    /// <summary>
    /// Time to simulate a setdown operation.
    /// </summary>
    private readonly int _setdownTime = (int)Math.Round(TimeSpan.FromSeconds(8).TotalMilliseconds);
    /// <summary>
    ...
    /// </summary>
    private readonly TimeSpan _positionBeaconDelay = TimeSpan.FromSeconds(30);
    /// <summary>
    ...
    /// </summary>
    public TimeSpan TurnResolveDelay
    {
        get;
        set => field = value;
    ...
    /// </summary>
    public int BatteryLevel => _robot.BatteryLevel;

    /// <summary>
    /// The current battery capacity of the robot.
    /// </summary>
    public int BatteryCapacity => _robot.BatteryCapacity;

    /// <summary>
    /// The current battery temperature of the robot.
    /// </summary>
    public int Temperature => _robot.Temperature;
    ...
    /// </summary>
    private int _previousCommandPIDLoops;
    /// <summary>
    ...
    /// </summary>
    private int _previousCommandFrames;
    /// <summary>
    ...
    /// </summary>
    public TimeSpan TimedTurningDelay
    {
        get;
        set => field = value;
    ...
    /// </summary>
    private readonly string _debugSnapshotDirectory = "";
    /// <summary>
    /// The number of debug snapshots taken.
    /// </summary>
    private int _currentDebugSnapshotCount;
    /// <summary>
    ...
    /// </summary>
    private readonly object _frameUpdateLock = new object();
    /// <summary>
    ...
    /// </summary>
    private int _currentSnapshotCount;
    /// <summary>
    ...
    /// </summary>
    private readonly Action<Hsv> _setFilter;
    /// <summary>
    ...
    public void SubmitCommand(string cmd)
    {
        ...
        if (RobotTranslator.CheckMessageValidnessTo(cmd))
        {
            ...
            // Decode the command
            var command = RobotTranslator.DecodeTo(cmd);
            switch (command.Type)
            {
    ...
    /// </summary>
    public int PIDKp { get => PIDControl.Kp;
        set => PIDControl.Kp = value;
    }

    /// <summary>
    /// The Ki of the PID-control loop.
    /// </summary>
    public int PIDKi { get => PIDControl.Ki;
        set => PIDControl.Ki = value;
    }
    ...
    /// </summary>
    private readonly Action<string> _newTagFoundCallback;
    /// <summary>
    /// Indicates whether this bot's RFID reader is running.
    /// </summary>
    public bool RFIDReaderConnected => !(_rfidReader == null) && _rfidReader.IsConnected;

    /// <summary>
    /// The audio player to use to signal newly found RFID-tags.
    /// </summary>
    private SoundPlayer _rfidFoundAudioPlayer = new SoundPlayer(Properties.Resources.AlienMotionTracker);
    ...
    /// </summary>
    public void DisconnectRFIDReader()
    {
    ...
    private void Run(object state)
    {
        while (!_terminationRequested())
        {
            ...
            var currentCommand = RobotActions.Forward;
...
public class RobotState
{
    ...
    /// </summary>
    public bool NewRFIDFound => _newRFIDFound;
