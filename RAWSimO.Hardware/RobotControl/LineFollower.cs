...
public class LineFollower
{
    ...
    /// </summary>
    private readonly RobotCtrl _robotControl;
    ...
    /// </summary>
    private int _medianImageSmoothingSize;
    /// <summary>
    ...
    /// </summary>
    private int _bilateralImageSmoothingSigmas;
    /// <summary>
    /// The sigma values for bilateral image smoothing. (Use 0 to deactivate the smoothing operation)
    /// </summary>
    public int BilateralImageSmoothingSigmas
    {
        get => _bilateralImageSmoothingSigmas;
        set
        {
            // Set to 0 if lower or zero to indicate deactivated smoothing
            if (value <= 0)
    ...
    /// </summary>
    private int _closingIterations;
    /// <summary>
    /// Number of closing iterations done. (0 indicates no closing at all.)
    /// </summary>
    ...
    /// </summary>
    public double FocusedLineSectionLeftOffset { get => _focusedLineSectionLeftBorder;
        set => _focusedLineSectionLeftBorder = value;
    }
    /// <summary>
    ...
    /// </summary>
    public double FocusedLineSectionRightOffset { get => 1 - _focusedLineSectionRightBorder;
        set => _focusedLineSectionRightBorder = 1 - value;
    }
    /// <summary>
    ...
    /// </summary>
    public double FocusedLineSectionTopOffset { get => 1 - _focusedLineSectionTopBorder;
        set => _focusedLineSectionTopBorder = 1 - value;
    }
    /// <summary>
    ...
    /// </summary>
    public double FocusedLineSectionBottomOffset { get => _focusedLineSectionBottomBorder;
        set => _focusedLineSectionBottomBorder = value;
    }
    ...
    /// </summary>
    public int OriginalFrameWidth => _originalFrameDimensions != null ? _originalFrameDimensions.Width : 0;

    /// <summary>
    /// The height of the camera image.
    /// </summary>
    public int OriginalFrameHeight => _originalFrameDimensions != null ? _originalFrameDimensions.Height : 0;
    ...
    /// </summary>
    private readonly TimeSpan _fpsMeasurementDelay = TimeSpan.FromSeconds(1);
    /// <summary>
    ...
    /// The number of images processed overall.
    /// </summary>
    public int ImagesProcessedOverall => _imagesProcessed;
    ...
    /// </summary>
    private readonly TimeSpan _ipMeasurementDelay = TimeSpan.FromSeconds(1);
    /// <summary>
    ...
    /// </summary>
    private int _houghFramesWithLine;
    /// <summary>
    /// Number of hough frames processed at whole.
    /// </summary>
    private int _houghFramesWhole;
    /// <summary>
    /// The fraction of successful line detections in terms of processed frames while in hough mode.
    /// </summary>
    public double CurrentHoughAccuracy => _houghFramesWhole != 0 ? (double)_houghFramesWithLine / (double)_houghFramesWhole : 0;
