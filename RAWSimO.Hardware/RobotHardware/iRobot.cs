...
public class iRobot
{
    ...
    /// </summary>
    private readonly int defaultSpeed = 30;
    /// <summary>
    ...
    /// </summary>
    private readonly byte[] _commandStop = new byte[] { (byte)RoombaOpCode.DRIVE, 0, 0, 0, 0 };
    /// <summary>
    ...
    /// The start command.
    /// </summary>
    private readonly byte[] _commandStart = new byte[] { 128 };
    /// <summary>
    ...
    /// </summary>
    private readonly byte[] _commandPowerDown = new byte[] { 133 };
    private readonly byte[] _commandOff = new byte[] { 173 };
    /// <summary>
    ...
    /// </summary>
    private readonly TimeSpan _packetRequestTimeout = TimeSpan.FromSeconds(3);
    /// <summary>
    /// The incoming bytes.
    /// </summary>
