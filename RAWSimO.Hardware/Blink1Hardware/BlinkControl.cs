...
public class BlinkControl
{
    ...
    /// </summary>
    private readonly RobotState _botState;
    /// <summary>
    ...
    /// </summary>
    private readonly int _updateTimeout = 100;
    /// <summary>
    /// The time for color fading.
    /// </summary>
    private readonly ushort _fadeTime = 200;
    /// <summary>
    /// The timeout for flipping the colors.
    /// </summary>
    private readonly TimeSpan _flipTimeout = TimeSpan.FromSeconds(1.5);
    /// <summary>
    ...
    /// Indicates whether to use flip-mode or combined color mode.
    /// </summary>
    public bool FlipMode { get => _flipMode;
        set { _flipMode = value; _modeChange = true; } }
    /// <summary>
    ...
    /// Contains the colors for the respective status.
    /// </summary>
    private readonly MultiKeyDictionary<RobotStatus, bool, IColorProcessor> _combinedColors;
    /// <summary>
