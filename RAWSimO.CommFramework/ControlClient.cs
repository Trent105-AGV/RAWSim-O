...
public class ControlClient
{
    ...
    /// </summary>
    private readonly Action<int, int, double> _robotPositionUpdateHandle;
    /// <summary>
    /// A callback that gets finished pickup operations passed.
    /// </summary>
    private readonly Action<int, bool> _robotPickupFinishedHandle;
    /// <summary>
    /// A callback that gets finished setdown operations passed.
    /// </summary>
    private readonly Action<int, bool> _robotSetdownFinishedHandle;
    /// <summary>
    ...
    public void HandleCommunication(string msg)
    {
        ...
        {
            var result = ControlTranslator.DecodeTo(msg);
            switch (result.Type)
            {
