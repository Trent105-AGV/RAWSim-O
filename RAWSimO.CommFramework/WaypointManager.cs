...
public class WaypointManager
{
    ...
    public class WaypointSearchResult
    {
        ...
        /// </summary>
        public readonly LinkedList<DTOWaypoint> Route = [];
        /// <summary>
    ...
    {
        var openLocations = new Dictionary<DTOWaypoint, WaypointSearchData>();
        var closedLocations = new Dictionary<DTOWaypoint, WaypointSearchData>();
    ...
    private void ReadWaypointsFile(string filePath)
    {
        ...
        var instance = InstanceIO.ReadDTOInstance(filePath);
    ...
    private void ReadDictFile(string filePath)
    {
        ...
        using (var sr = new StreamReader(filePath))
        {
            ...
            while (sr.ReadLine() is { } line)
            {
                ...
                var entry = line.Split(';').Select(e => e.Trim()).ToArray();
