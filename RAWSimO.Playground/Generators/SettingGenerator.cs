...
internal class SettingGenerator
{
    internal static void GenerateRotterdamMark2Set()
    {
        ...
        // SKUs
        var skuScenarios = new List<string>
        {
            // 100 SKUs
            "Mu-100.xgenc",
            // 500 SKUs
        ...
        // BotsPerOStation
        var botsPerOStationCounts = new List<int>
        {
        ...
        // OStationCapacity
        var oStationCapacities = new List<int>
        {
        ...
        var iStationAmounts = new List<double>
        {
        ...
        {
            // Save
            var fileName = config.Name + ".xsett";
