...
public partial class Instance
{
    ...
    /// </summary>
    private readonly Dictionary<SanityError, string> _sanityErrorDescriptions = new()
    {
    ...
    {
        var errors = new List<Tuple<SanityError, string>>();
        ...
        var storageLocations = Waypoints.Count(w => w.PodStorageLocation);
