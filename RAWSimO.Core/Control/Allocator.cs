...
public class Allocator : IUpdateable
{
    ...
    /// </summary>
    private readonly Dictionary<ItemBundle, InputStation> _iStationAssignments = new();
    /// <summary>
    /// All decided but not yet allocated bundle to pod assignments.
    /// </summary>
    private readonly Dictionary<ItemBundle, Pod> _podAssignments = new();
    ...
    public void Update(double lastTime, double currentTime)
    {
        ...
        {
            var bundles = Instance.ControllerConfig.ItemStorageConfig.GetMethodType() != ItemStorageMethodType.Dummy ?
