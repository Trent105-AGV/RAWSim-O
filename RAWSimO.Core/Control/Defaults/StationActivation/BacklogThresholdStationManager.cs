...
/// </summary>
internal class BacklogThresholdStationManager : StationManager
{
    /// <summary>
    ...
    /// </summary>
    private readonly BacklogThresholdStationActivationConfiguration _config;
    /// <summary>
    ...
    /// </summary>
    private readonly List<OutputStation> _oStations;
    /// <summary>
    /// All input-stations in the order in which they shall get (de-)activated.
    /// </summary>
    private readonly List<InputStation> _iStations;
    ...
    public override void Update(double lastTime, double currentTime)
    {
        ...
        if (currentTime - _lastOStationTrigger > _config.Timeout)
        {
            ...
            var activateStation = Instance.ItemManager.BacklogOrderCount > _config.OStationActivateThreshold;
            var deactivateStation =
        ...
        {
            // Check whether we have to (de-)activate a station
            var activateStation = Instance.ItemManager.BacklogBundleCount > _config.IStationActivateThreshold;
            var deactivateStation =
                // Is any station active at all?
