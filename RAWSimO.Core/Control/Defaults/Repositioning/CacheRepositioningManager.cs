...
public class CacheRepositioningManager : RepositioningManager
{
    ...
    /// The configuration.
    /// </summary>
    private readonly CacheRepositioningConfiguration _config;
    /// <summary>
    ...
    /// </summary>
    private readonly Dictionary<Waypoint, OutputStation> _stationsOfStorageLocations = new();
    /// <summary>
    ...
    /// </summary>
    private BestCandidateSelector _bestCandidateSelectorClear;
    /// <summary>
    /// A helper used to determine the best candidate (fill move).
    /// </summary>
    private BestCandidateSelector _bestCandidateSelectorFill;
    /// <summary>
        ...
        if (_bestCandidateSelectorClear == null)
        {
            _bestCandidateSelectorClear = new BestCandidateSelector(false,
                ...
                () =>
                {
                    ...
                    var potentialPicks = Instance.ResourceManager.GetExtractRequestsOfStation(_currentStation)
                ...
                () =>
                {
                    ...
                    var potentialPicks = _currentPod.ItemDescriptionsContained.Sum(i => Math.Min(_currentPod.CountContained(i),
