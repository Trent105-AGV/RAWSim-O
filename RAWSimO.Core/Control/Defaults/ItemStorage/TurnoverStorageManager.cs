...
internal class TurnoverStorageManager : ItemStorageManager
{
    ...
    public override Pod SelectPodForInititalInventory(Instance instance, ItemBundle bundle)
    {
        ...
        var chosenPod = ChoosePod(bundle);
        if (chosenPod == null)
    ...
    /// </summary>
    private readonly TurnoverItemStorageConfiguration _config;
    /// <summary>
    ...
    /// </summary>
    private readonly Dictionary<int, Pod> _lastChosenPodByClass = new();
    /// <summary>
    /// The last pod chosen per class in reverse.
    /// </summary>
    private readonly Dictionary<Pod, int> _lastChosenPodByClassReverse = new();
    /// <summary>
    /// Relative reserved capacity by class above which the pod gets refilled.
    /// </summary>
    private readonly double[] _classReservedCapacityPercentageForRefill;
    /// <summary>
    /// The buffer timeout per storage class.
    /// </summary>
    private readonly double[] _classBufferTimeout;
    ...
    private Pod ChoosePod(ItemBundle bundle)
    {
        ...
        var desiredStorageClass = _classManager.DetermineStorageClass(bundle);
