...
public class ConceptBotManager : BotManager
{
    ...
    private readonly ConceptTaskAllocationConfiguration _config;
    ...
    protected override void GetNextTask(Bot bot)
    {
        ...
        var keepPod = bot.Pod != null && Instance.Randomizer.NextDouble() < 0.5;
        var extractMode = Instance.Randomizer.NextDouble() < _config.ExtractModeProb;
        ...
        var restLocation = Instance.ResourceManager.UnusedRestingLocations.ElementAt(Instance.Randomizer.NextInt(Instance.ResourceManager.UnusedRestingLocations.Count()));
