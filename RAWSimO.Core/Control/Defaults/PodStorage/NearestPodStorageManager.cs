...
public class NearestPodStorageManager : PodStorageManager
{
    ...
    /// </summary>
    private readonly NearestPodStorageConfiguration _config;
    ...
    protected override Waypoint GetStorageLocationForPod(Pod pod)
    {
        ...
        var podLocation = // Get current waypoint of pod, if we want to estimate a path
        ...
        foreach (var storageLocation in Instance.ResourceManager.UnusedPodStorageLocations)
        {
            ...
            {
                NearestPodStorageLocationDisposeRule.Euclid => Distances.CalculateEuclid(pod, storageLocation,
                    Instance.WrongTierPenaltyDistance),
                NearestPodStorageLocationDisposeRule.Manhattan => Distances.CalculateManhattan(pod, storageLocation,
                    Instance.WrongTierPenaltyDistance),
                NearestPodStorageLocationDisposeRule.ShortestPath => Distances.CalculateShortestPathPodSafe(podLocation,
                    storageLocation, Instance),
                NearestPodStorageLocationDisposeRule.ShortestTime => Distances.CalculateShortestTimePathPodSafe(
                    podLocation, storageLocation, Instance),
