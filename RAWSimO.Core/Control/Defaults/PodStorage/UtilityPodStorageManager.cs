...
public class UtilityPodStorageManager : PodStorageManager
{
    ...
    /// </summary>
    private readonly UtilityPodStorageConfiguration _config;
    /// <summary>
    ...
    protected override Waypoint GetStorageLocationForPod(Pod pod)
    {
        ...
        var bestStorageLocation = Instance.SharedControlElements.PodUtilityManager.GetStorageLocation(pod, Instance.WaypointGraph.GetClosestWaypoint(pod.Tier, pod.X, pod.Y));
        // Return it
