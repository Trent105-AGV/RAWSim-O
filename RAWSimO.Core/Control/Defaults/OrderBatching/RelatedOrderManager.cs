...
public class RelatedOrderManager : OrderManager
{
    ...
    /// </summary>
    private readonly RelatedOrderBatchingConfiguration _config;
    ...
    protected override void DecideAboutPendingOrders()
    {
        ...
        {
            var chosenStation = Instance.OutputStations
                ...
                .ThenBy(s =>
                {
                    ...
                    {
                        RelatedOrderBatchingTieBreaker.Random => Instance.Randomizer.NextDouble(),
                        RelatedOrderBatchingTieBreaker.LeastBusy => s.AssignedOrders.Count(),
                        RelatedOrderBatchingTieBreaker.MostBusy => -s.AssignedOrders.Count(),
                        _ => throw new ArgumentException("Unknown tie-breaker: " + _config.TieBreaker)
                    };
                })
