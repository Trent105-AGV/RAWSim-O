...
public class ParkPodTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.ParkPod;

    /// <summary>
    /// The storage location to use for the pod.
    /// </summary>
    public Waypoint StorageLocation { get; }
    /// <summary>
    /// The pod to store.
    /// </summary>
    public Pod Pod { get; }
...
public class RepositionPodTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.RepositionPod;
...
public class ExtractTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.Extract;

    /// <summary>
    /// The output station to bring the pod to.
    /// </summary>
    public OutputStation OutputStation { get; }
    /// <summary>
    /// The requests to finish by executing this task.
    /// </summary>
    public List<ExtractRequest> Requests { get; }
    /// <summary>
    /// The pod to use for this task.
    /// </summary>
    public Pod ReservedPod { get; }
    /// <summary>
...
public class InsertTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.Insert;
    ...
    /// The requests to finish by executing this task.
    /// </summary>
    public List<InsertRequest> Requests { get; }
    /// <summary>
...
public class RestTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.Rest;

    /// <summary>
    /// The location at which the robot shall rest.
    /// </summary>
    public Waypoint RestingLocation { get; }
    /// <summary>
    /// Prepares everything for executing the task (claiming resources and similar).
    /// </summary>
    public override void Prepare()
...
public class DummyTask : BotTask
{
    ...
    /// The type of the task.
    /// </summary>
    public override BotTaskType Type => BotTaskType.None;
