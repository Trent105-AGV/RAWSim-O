...
public class LayoutConfiguration
{
    ...
    /// </summary>
    public readonly AisleLayoutTypes AisleLayoutType = AisleLayoutTypes.Tim;
    /// <summary>
    ...
    private void AdjustToOverrideValue(int targetValue, ref int firstValue, ref int secondValue, ref int thirdValue, ref int fourthValue)
    {
        ...
        var currentValue = firstValue + secondValue + thirdValue + fourthValue;
        var currentValueToModify = 0;
    ...
    {
        var lengthDueToStorageLocations = (NrVerticalAisles + 1) * HorizontalLengthBlock;
        var lengthDueToAisles = widthAisles() * NrVerticalAisles;
        var lengthDueToRingwayAroundStorageArea = 2 * WidthRingway;
        return lengthDueToStorageLocations + lengthDueToAisles + lengthDueToRingwayAroundStorageArea;
    }

    internal int widthStorageArea()
    {
        var lengthDueToStorageLocations = (NrHorizontalAisles + 1) * VerticalLengthBlock;
        var lengthDueToAisles = widthAisles() * NrHorizontalAisles;
        var lengthDueToRingwayAroundStorageArea = 2 * WidthRingway;
        return lengthDueToStorageLocations + lengthDueToAisles + lengthDueToRingwayAroundStorageArea;
    }
    ...
    {
        var distance = HorizontalLengthBlock + widthAisles();
        return 2 * distance;
    }

    internal int distanceBetweenPossibleExitLocationsAtWestOrEastHall()
    {
        var distance = VerticalLengthBlock + widthAisles();
        return 2 * distance;
    }
