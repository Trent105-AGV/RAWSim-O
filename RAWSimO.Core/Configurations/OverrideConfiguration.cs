...
public class OverrideConfiguration
{
    ...
    /// </summary>
    public readonly double OverrideBotPodTransferTimeValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideBotPodTransferTime = false;
    /// <summary>
    /// The acceleration of the robots.
    /// </summary>
    public readonly double OverrideBotMaxAccelerationValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideBotMaxAcceleration = false;
    /// <summary>
    /// The deceleration of the robots.
    /// </summary>
    public readonly double OverrideBotMaxDecelerationValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideBotMaxDeceleration = false;
    /// <summary>
    /// The maximal velocity of the robots.
    /// </summary>
    public readonly double OverrideBotMaxVelocityValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideBotMaxVelocity = false;
    /// <summary>
    /// The turning speed of the robots.
    /// </summary>
    public readonly double OverrideBotTurnSpeedValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideBotTurnSpeed = false;
    /// <summary>
    /// The capacity of the pods.
    /// </summary>
    public readonly double OverridePodCapacityValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverridePodCapacity = false;
    /// <summary>
    /// The capacity of the input stations.
    /// </summary>
    public readonly double OverrideInputStationCapacityValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideInputStationCapacity = false;
    /// <summary>
    ...
    /// </summary>
    public readonly double OverrideInputStationItemBundleTransferTimeValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideInputStationItemBundleTransferTime = false;
    /// <summary>
    /// The time it takes to handle an item at a pick station.
    /// </summary>
    public readonly double OverrideOutputStationItemTransferTimeValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideOutputStationItemTransferTime = false;
    /// <summary>
    /// The time it takes for picking an item.
    /// </summary>
    public readonly double OverrideOutputStationItemPickTimeValue = double.NaN;
    /// <summary>
    /// Indicates whether to override the values given by the instance for the parameter.
    /// </summary>
    public readonly bool OverrideOutputStationItemPickTime = false;
}