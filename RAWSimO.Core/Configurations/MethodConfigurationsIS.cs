...
public class TurnoverItemStorageConfiguration : ItemStorageConfiguration
{
    ...
    /// </summary>
    public readonly double ReallocationDelay = 0.0;
    /// <summary>
    ...
    /// </summary>
    public readonly bool EmptiestInsteadOfRandom = true;
    /// <summary>
    /// Specifies the threshold of the reserved capacity above which the pods are refilled.
    /// </summary>
    public readonly string BufferThresholdPerClass = "0.8" + IOConstants.DELIMITER_LIST + "0.8" + IOConstants.DELIMITER_LIST + "0.8";
    /// <summary>
    /// The time after which buffered bundles will be allocated even if they do not meet the threshold criterion.
    /// </summary>
    public readonly string BufferTimeoutPerClass = "1200" + IOConstants.DELIMITER_LIST + "1200" + IOConstants.DELIMITER_LIST + "1200";
}
/// <summary>
/// The configuration for the corresponding method.
/// </summary>
...
public class ReactiveItemStorageConfiguration : ItemStorageConfiguration
{
    ...
    /// </summary>
    public readonly ReactiveItemStorageAllocationRule AllocationRule = ReactiveItemStorageAllocationRule.RandomSameTier;
    /// <summary>
    /// Specifies the threshold of the reserved capacity above which the pods are refilled.
    /// </summary>
    public readonly double BufferThreshold = 0.8;
...
public class EmptiestItemStorageConfiguration : ItemStorageConfiguration
{
    ...
    /// </summary>
    public readonly bool StickToPodUntilFull = true;
    /// <summary>
    /// Specifies the threshold of the reserved capacity above which the pods are refilled.
    /// </summary>
    public readonly double BufferThreshold = 0.8;
