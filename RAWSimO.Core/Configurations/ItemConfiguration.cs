...
public class ColoredWordConfiguration
{
    ...
    public ColoredWordConfiguration(DefaultConstructorIdentificationClass param) : this()
    {
        ColorProbabilities =
        [
            new() { Key = LetterColors.Blue, Value = 1.0 / 3.0 },
            new() { Key = LetterColors.Green, Value = 1.0 / 3.0 },
            new() { Key = LetterColors.Red, Value = 1.0 / 3.0 }
        ];
    }
    /// <summary>
    ...
    /// </summary>
    public readonly List<Skvp<LetterColors, double>> ColorProbabilities;
}
