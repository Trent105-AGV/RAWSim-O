...
public class PCScorerIStationForBotWithPodNearest : PCScorerIStationForBotWithPod
{
    ...
    /// Indicates whether to prefer the same tier.
    /// </summary>
    public readonly DistanceMetricType DistanceMetric = DistanceMetricType.Euclidean;
}
/// <summary>
/// Exposes the parameters for the given pod selection scorer / strategy.
/// </summary>
public class PCScorerIStationForBotWithPodWorkAmount : PCScorerIStationForBotWithPod
{
    ...
    /// </summary>
    public readonly bool IncludeAge = false;
    /// <summary>
    /// Indicates whether to prefer the same tier.
    /// </summary>
    public readonly bool PreferSameTier = true;
...
public class PCScorerPodForIStationBotNearest : PCScorerPodForIStationBot
{
    ...
    /// </summary>
    public readonly bool EstimateBotPodDistance = true;
}
/// <summary>
/// Exposes the parameters for the given pod selection scorer / strategy.
/// </summary>
...
public class PCScorerPodForOStationBotFill : PCScorerPodForOStationBot
{
    ...
    /// </summary>
    public readonly bool PreferFullest = true;
    /// <summary>
    ...
    /// </summary>
    public readonly double Threshold = 0.7;
}
/// <summary>
/// Exposes the parameters for the given pod selection scorer / strategy.
/// </summary>
public class PCScorerPodForOStationBotNearest : PCScorerPodForOStationBot
{
    ...
    /// Indicates whether to prefer the same tier.
    /// </summary>
    public readonly DistanceMetricType DistanceMetric = DistanceMetricType.ShortestTime;
    /// <summary>
    /// Indicates whether to estimate the distance between the bot and the pod instead of fully calculating it.
    /// </summary>
    public readonly bool EstimateBotPodDistance = true;
...
public class PCScorerPodForOStationBotWorkAmount : PCScorerPodForOStationBot
{
    ...
    /// </summary>
    public readonly bool EstimateBotPodDistancePenalty = true;
    /// <summary>
    ...
    /// </summary>
    public readonly bool EstimatePodStationDistancePenalty = false;
}
...
public class DefaultPodSelectionConfiguration : ControllerConfigurationBase
{
    ...
    /// </summary>
    public readonly bool OnTheFlyExtract = true;
    /// <summary>
    /// Indicates whether more suitable insert requests are included in an ongoing store task on-the-fly.
    /// </summary>
    public readonly bool OnTheFlyStore = true;
    /// <summary>
    /// Indicates the mode for filtering suitable pods for picking.
    /// </summary>
    public readonly PodSelectionExtractRequestFilteringMode FilterForConsideration = PodSelectionExtractRequestFilteringMode.AssignedAndCompleteQueued;
    /// <summary>
    /// Indicates the mode for filtering the requests when deciding the actual reservations for a pod.
    /// </summary>
    public readonly PodSelectionExtractRequestFilteringMode FilterForReservation = PodSelectionExtractRequestFilteringMode.AssignedAndCompleteQueued;
    ...
    public override string GetMethodName()
    {
        ...
        var name = "";
        name += InputPodScorer.Type() switch
        {
            PrefPodForIStationBot.Random => "r",
            PrefPodForIStationBot.Nearest => "n",
            PrefPodForIStationBot.WorkAmount => "w",
            _ => throw new ArgumentException("Unexpected argument!")
        };
        name += OutputPodScorer.Type() switch
        {
            PrefPodForOStationBot.Random => "r",
            PrefPodForOStationBot.Fill => "f",
            PrefPodForOStationBot.Nearest => "n",
            PrefPodForOStationBot.Completeable => "c",
            PrefPodForOStationBot.WorkAmount => "w",
            _ => throw new ArgumentException("Unexpected argument!")
        };
        name += InputExtendedSearchScorer.Type() switch
        {
            PrefIStationForBotWithPod.Random => "r",
            PrefIStationForBotWithPod.Nearest => "n",
            PrefIStationForBotWithPod.WorkAmount => "w",
            _ => throw new ArgumentException("Unexpected argument!")
        };
        name += OutputExtendedSearchScorer.Type() switch
        {
            PrefOStationForBotWithPod.Random => "r",
            PrefOStationForBotWithPod.Nearest => "n",
            PrefOStationForBotWithPod.WorkAmount => "w",
            _ => throw new ArgumentException("Unexpected argument!")
        };
        return name;
    }
