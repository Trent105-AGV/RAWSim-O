...
public class CacheDropoffRepositioningConfiguration : RepositioningConfiguration
{
    ...
    /// </summary>
    public readonly bool PreferSameTierMoves = false;
    /// <summary>
    /// The targeted fill level of the cache.
    /// </summary>
    public readonly double TargetFillCache = 0.8;
    /// <summary>
    ...
    /// </summary>
    public readonly CacheStorageLocationSelectionRule PodDisposeRule = CacheStorageLocationSelectionRule.Manhattan;
    /// <summary>
    ...
    /// </summary>
    public readonly double GlobalTimeout = 120;
}
/// <summary>
/// The configuration for the corresponding method.
/// </summary>
