...
public class ControlConfiguration
{
    ...
    /// </summary>
    public readonly MethodManagementConfiguration MethodManagementConfig;
    /// <summary>
    /// Some optional comment tag that will be written to the footprint.
    /// </summary>
    public readonly string CommentTag1 = "";
    /// <summary>
    /// Some optional comment tag that will be written to the footprint.
    /// </summary>
...
public abstract class PathPlanningConfiguration : ControllerConfigurationBase
{
    ...
    /// </summary>
    public readonly bool CanTunnel = true;
    /// <summary>
    ...
    /// </summary>
    public readonly double RunTimeLimitOverall = 1.0;
