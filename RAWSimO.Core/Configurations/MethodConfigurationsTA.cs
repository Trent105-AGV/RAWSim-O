...
public class RandomTaskAllocationConfiguration : TaskAllocationConfiguration
{
    ...
    /// </summary>
    public readonly bool SwitchModeIfNoWork = true;
    /// <summary>
    /// Indicates whether to do repositioning moves (if available), if no other tasks are available.
    /// </summary>
    public readonly bool DoRepositioningIfNoWork = true;
    /// <summary>
    ...
    /// </summary>
    public readonly double StickToModeProbability = 0.9;
    /// <summary>
    ...
    /// </summary>
    public readonly double StickToPodProbability = 0.95;
    /// <summary>
    ...
    /// </summary>
    public readonly double RepositioningProbability = 0.05;
}
/// <summary>
/// The configuration for the corresponding method.
/// </summary>
public class BalancedTaskAllocationConfiguration : TaskAllocationConfiguration
{
    ...
    public override string GetMethodName()
    {
        ...
        name += RestLocationOrderType switch
        {
            PrefRestLocationForBot.Random => "r",
            PrefRestLocationForBot.RandomSameTier => "t",
            PrefRestLocationForBot.Middle => "c",
            PrefRestLocationForBot.MiddleSameTier => "m",
            PrefRestLocationForBot.Nearest => "n",
    ...
    /// </summary>
    public readonly double BotReallocationTimeout = 30.0;
    /// <summary>
    ...
    /// </summary>
    public readonly int BotsPerStationLimit = 9;
    /// <summary>
    /// Indicates whether the bot will search for work to do on the same tier it is located on first.
    /// </summary>
    public readonly bool PreferSameTier = true;
    ...
    /// </summary>
    public readonly bool ExtendSearch = false;
    /// <summary>
    ...
    /// </summary>
    public readonly bool SearchAll = false;
    /// <summary>
    ...
    /// </summary>
    public DefaultPodSelectionConfiguration PodSelectionConfig = new();
    /// <summary>
    /// The order to use when looking for a suitable resting location.
    /// </summary>
    public readonly PrefRestLocationForBot RestLocationOrderType = PrefRestLocationForBot.MiddleSameTier;
}
/// <summary>
/// The configuration for the corresponding method.
/// </summary>
public class SwarmTaskAllocationConfiguration : TaskAllocationConfiguration
{
    ...
    /// </summary>
    public readonly double multiplikator = 1.2;
    /// <summary>
    /// "Comment me"
    /// </summary>
    public readonly int maxMultiplikatorValue = 30;
    /// <summary>
    /// hardness of probability of a rest task
    /// </summary>
    public readonly double restPercentage = 0.8;
    /// <summary>
    /// Sets the Maximum of Bots per Station
    /// </summary>
    public readonly int maximumBotsPerStation = 6;
    /// <summary>
    /// Indicates whether the bot will search for work to do with its current pod for another station, if there is no more work for its current station-pod combination.
    /// </summary>
    public readonly bool ExtendSearch = false;
    ...
    /// The radius in which a station has to be in order to be considered for the search expansion. The distance is measured from the station the bot is assigned to.
    /// </summary>
    public readonly double ExtendedSearchRadius = 5.0;
    /// <summary>
    /// The sub configuration for selecting the pods for picking and replenishment.
    /// </summary>
    public readonly DefaultPodSelectionConfiguration PodSelectionConfig = new();
    /// <summary>
    /// The order to use when looking for a suitable resting location.
    /// </summary>
    public readonly PrefRestLocationForBot RestLocationOrderType = PrefRestLocationForBot.Nearest;
    /// <summary>
    /// Checks whether the task allacation configuration is valid.
    /// </summary>
    /// <param name="errorMessage">A message describing the error if the configuration is not valid.</param>
...
public class ConstantRatioTaskAllocationConfiguration : TaskAllocationConfiguration
{
    ...
    /// </summary>
    public readonly double PickBotRatio = 0.75;
    /// <summary>
    ...
    /// </summary>
    public readonly double RefreshAllocationTimeout = 30;
    /// <summary>
...
public class ConceptTaskAllocationConfiguration : TaskAllocationConfiguration
{
    ...
    /// </summary>
    public readonly double ExtractModeProb = 0.7;
}
