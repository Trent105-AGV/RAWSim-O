...
public class CacheConfiguration
{
    ...
    /// </summary>
    public readonly double CacheFraction = 0.25;
    /// <summary>
    /// The absolute number of drop-off locations per station.
    /// </summary>
    public readonly int DropoffCount = 0;
    /// <summary>
    /// Indicates the preference between the different zones.
    /// </summary>
    public readonly ZonePriority ZonePriority = ZonePriority.DropoffFirst;
    /// <summary>
