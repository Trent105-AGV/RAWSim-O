...
public class ConstantRatioStationActivationConfiguration : StationActivationConfiguration
{
    ...
    /// </summary>
    public readonly double ActiveRatio = 0.5;
    /// <summary>
    ...
    /// </summary>
    public readonly double PickReplenishRatio = 0.5;
}
...
public class WorkShiftStationActivationConfiguration : StationActivationConfiguration
{
    ...
    public WorkShiftStationActivationConfiguration(DefaultConstructorIdentificationClass param) : this()
    {
        Shifts =
        [
            new() { Key = TimeSpan.FromHours(0).TotalSeconds, Value = false },
            new() { Key = TimeSpan.FromHours(6).TotalSeconds, Value = true },
            new() { Key = TimeSpan.FromHours(22).TotalSeconds, Value = false }
        ];
    }
    /// <summary>
    /// Returns the type of the corresponding method this configuration belongs to.
    ...
    /// </summary>
    public readonly List<Skvp<double, bool>> Shifts;
    /// <summary>
    ...
    /// </summary>
    public readonly double LoopTime = TimeSpan.FromDays(1).TotalSeconds;
}
