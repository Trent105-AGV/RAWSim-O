...
public class Tier : InstanceElement, IUpdateable, ITierInfo
{
    ...
    /// </summary>
    internal readonly QuadTree<Bot> BotQuadTree;

    /// <summary>
    /// The quad-tree observing positions and collisions of the pods on this tier.
    /// </summary>
    internal readonly QuadTree<Pod> PodQuadTree;

    /// <summary>
    /// All input-stations on this tier.
    /// </summary>
    internal readonly List<InputStation> InputStations = [];

    /// <summary>
    /// All output-stations on this tier.
    /// </summary>
    internal readonly List<OutputStation> OutputStations = [];

    /// <summary>
    /// Set of all bots currently located on this tier.
    /// </summary>
    internal readonly HashSet<Bot> Bots = [];

    /// <summary>
    /// Set of all pods currently located on this tier.
    /// </summary>
    internal readonly HashSet<Pod> Pods = [];

    /// <summary>
    /// Set of waypoints on this tier.
    /// </summary>
    internal IEnumerable<Waypoint> Waypoints => Instance.WaypointGraph.GetWayPoints()[this];

    /// <summary>
    /// Exposes all bots currently located on this tier.
    /// </summary>
    public IEnumerable<Bot> CurrentBots => Bots;

    /// <summary>
    /// Exposes all pods currently located on this tier.
    /// </summary>
    public IEnumerable<Pod> CurrentPods => Pods;
    ...
    public double GetShortestTimeWithoutCollision()
    {
        ...
        var maxVel = 0.001;	//start non-zero
        ...
        var diam = 1.8 * Instance.Bots.First().Radius;
        return diam / maxVel;
    }
    ...
    public override string GetIdentfierString() { return "Tier" + ID; }
    /// <summary>
    /// Returns a simple string giving information about the object.
    /// </summary>
    /// <returns>A simple string.</returns>
    public override string ToString() { return "Tier" + ID; }
