...
public class InputStation : Circle, IUpdateable, IInputStationInfo, IQueuesOwner, IExposeVolatileID
{
    ...
    /// </summary>
    private readonly HashSet<ItemBundle> _itemBundles = [];

    /// <summary>
    /// The set of bundles not yet allocated but already registered with this station.
    /// </summary>
    public HashSet<ItemBundle> RegisteredBundles => _registeredBundles;
    ...
    /// Contains information about the items currently contained in this station.
    /// </summary>
    public IEnumerable<ItemBundle> ItemBundles => _itemBundles;
    ...
    /// </summary>
    public double RemainingCapacity => Capacity - CapacityInUse - CapacityReserved;
    ...
    public void GiveBundleToPod(double currentTime)
    {
        while (_requestsInsert.Count > 0)
        {
            ...
            var pod = bot.Pod;
            var request = _requestsInsert.Dequeue();
    ...
    /// </summary>
    public readonly Queue<InsertRequest> _requestsInsert = new();
    /// <summary>
    ...
    /// </summary>
    internal int StatCurrentlyOpenBundles => _itemBundles.Count;
    ...
    /// </summary>
    public double StatBundlePileOn => _statPodHandling == null ? 0 : StatNumBundlesStored / (double)_statPodHandling.PodsHandled;
    ...
    /// </summary>
    public double StatInjectedBundlePileOn => _statPodHandling == null ? 0 : StatNumInjectedBundlesStored / (double)_statPodHandling.PodsHandled;
    ...
    public override string GetIdentfierString() { return "InputStation" + ID; }
    /// <summary>
    /// Returns a simple string giving information about the object.
    /// </summary>
    /// <returns>A simple string.</returns>
    public override string ToString() { return "InputStation" + ID; }
