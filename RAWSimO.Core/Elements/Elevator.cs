...
public class Elevator : InstanceElement, IQueuesOwner, IElevatorInfo
{
    ...
    /// </summary>
    private HashSet<Waypoint> _connectedPoints = [];

    /// <summary>
    /// Exposes all waypoints connected by the elevator.
    /// </summary>
    public ICollection<Waypoint> ConnectedPoints => _connectedPoints;

    /// <summary>
    /// Contains the time necessary to move the elevator from the source waypoint to the destination waypoint.
    /// </summary>
    private readonly Dictionary<Waypoint, Dictionary<Waypoint, double>> _timings = new();
    ...
    public override string GetIdentfierString() { return "Elevator" + ID; }
    /// <summary>
    /// Returns a simple string giving information about the object.
    /// </summary>
    /// <returns>A simple string.</returns>
    public override string ToString() { return "Elevator" + ID; }
