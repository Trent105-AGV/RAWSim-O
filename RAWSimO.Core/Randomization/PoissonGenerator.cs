...
public class PoissonGenerator
{
    ...
    /// </summary>
    public List<double> TimeDependentRateSteps { get; }
    /// <summary>
    /// The rates depending on the current time.
    /// </summary>
    public Dictionary<double, double> TimeDependentRates { get; }
    #endregion
    ...
    public double Next(double currentTime, double distortionFactor = 1)
    {
        ...
        switch (Mode)
        {
            ...
            case PoissonMode.TimeDependent:
            {
                ...
                var index = TimeDependentRateSteps.BinarySearch(currentTime);
                if (index < 0)
                    index = ~index - 1;
                // Calculate the value
            ...
            default: throw new ArgumentException("Unknown poisson mode: " + Mode);
        }
    }
