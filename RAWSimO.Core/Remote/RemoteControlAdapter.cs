...
public class RemoteControlAdapter
{
    ...
    public void RobotLocationUpdateCallback(int robotID, int waypointID, double orientation)
    {
        ...
        {
            _instance.LogSevere(
                "Error when remotely updating location of bot " + robotID +
                " to waypoint " + waypointID +
    ...
    public void RobotPickupFinishedCallback(int robotID, bool success)
    {
        ...
        {
            _instance.LogSevere(
                "Error when remotely finishing pickup operation of bot " + robotID +
                ": " + ex.Message);
        }
    }
    /// <summary>
    ...
    public void RobotSetdownFinishedCallback(int robotID, bool success)
    {
        ...
        {
            _instance.LogSevere(
                "Error when remotely finishing setdown operation of bot " + robotID +
                ": " + ex.Message);
        }
    }
}