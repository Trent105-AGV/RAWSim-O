...
public class InstanceGenerator
{
    ...
    {
        var layoutGenerator = new LayoutGenerator(layoutConfiguration, settingConfig, controlConfig, logAction);
        var instance = layoutGenerator.GenerateLayout();
    ...
    {
        var layoutConfiguration = GenerateMaTiLayoutConfiguration();
