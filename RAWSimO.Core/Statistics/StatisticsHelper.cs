...
public class StatisticsHelper
{
    ...
    {
        // Calculate position
        var position = (int)(values.Count() * (1.0 / 4.0)); // In case of two quantiles return the lower quantile
    ...
    {
        // Calculate position
        var position = (int)(values.Count() * (2.0 / 4.0)); // In case of two quantiles return the lower quantile
        // Order the values and return the element at the calculated position
        return values.OrderBy(v => v).ElementAt(position);
    }
    /// <summary>
    ...
    {
        // Calculate position
        var position = (int)(values.Count() * (3.0 / 4.0)); // In case of two quantiles return the lower quantile
        // Order the values and return the element at the calculated position
        return values.OrderBy(v => v).ElementAt(position);
    }
}