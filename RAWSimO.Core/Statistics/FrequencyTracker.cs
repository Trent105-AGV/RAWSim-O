...
public class FrequencyTracker
{
    ...
    /// </summary>
    private readonly Dictionary<ItemDescription, int> _itemOrderCount = new();
    /// <summary>
    ...
    /// </summary>
    private readonly Dictionary<ItemDescription, int> _modifiableOrderCount = new();
    /// <summary>
    /// The frequencies of all items.
    /// </summary>
    private readonly Dictionary<ItemDescription, double> _itemFrequency = new();
    /// <summary>
    ...
    /// </summary>
    private readonly SymmetricKeyDictionary<ItemDescription, int> _combinedItemOrderCount = new();
    /// <summary>
    /// The correlations between the different item-types.
    /// </summary>
    private readonly SymmetricKeyDictionary<ItemDescription, double> _combinedItemFrequencies = new();
