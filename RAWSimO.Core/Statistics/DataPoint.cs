...
public class FootprintDatapoint
{
    ...
    /// </summary>
    private readonly Dictionary<FootPrintEntry, Type> _entryTypes = new()
    {
        // --> Setup
    ...
    /// </summary>
    private readonly Dictionary<FootPrintEntry, object> _entryValues = new();
    /// <summary>
    ...
    public object this[FootPrintEntry entry] => _entryValues[entry];
    ...
    public FootprintDatapoint(Instance instance)
    {
        ...
        var overallPodsHandled = (int)_entryValues[FootPrintEntry.OverallPodsHandledAtIStations] + (int)_entryValues[FootPrintEntry.OverallPodsHandledAtOStations];
    ...
    {
        // Get elements
        var elements = footprintline.Split(IOConstants.DELIMITER_VALUE);
        // Check count
        ...
        foreach (var entryDescription in EntryOrder)
        {
            ...
            if (!_entryValues.ContainsKey(entryDescription))
                throw new ArgumentException("Unexpected type of the element to parse: " + _entryTypes[entryDescription]);
    ...
    {
        // Fill header
        var delim = IOConstants.DELIMITER_VALUE.ToString();
...
public class WellSortednessDatapoint
{
    ...
    {
        var firstLevel = datapointLine.Split(IOConstants.DELIMITER_VALUE);
        TimeStamp = double.Parse(firstLevel[0], IOConstants.FORMATTER);
        var secondLevel = firstLevel[1].Split(IOConstants.DELIMITER_LIST);
        PathTimeFrequencies = secondLevel.Select(e =>
        {
            var thirdLevel = e.Split(IOConstants.DELIMITER_TUPLE);
            var tuple = new WellSortednessPathTimeTuple();
...
public class ItemDescriptionFrequencyDatapoint
{
    ...
    /// </summary>
    public readonly int ItemDescriptionID;
    /// <summary>
    ...
    /// </summary>
    public readonly double MeasuredFrequency;
    /// <summary>
    /// The static frequency.
    /// </summary>
    public readonly double StaticFrequency;
    ...
    {
        var values = line.Split(IOConstants.DELIMITER_VALUE);
...
public class ConnectionStatisticsDataPoint
{
    ...
    {
        var values = s.Split(IOConstants.DELIMITER_VALUE);
...
public class CustomControllerDatapoint
{
    ...
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogPPString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPP1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPP2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPP3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPP4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogTAString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogTA1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogTA2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogTA3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogTA4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    ...
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPC4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogSAString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogSA1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogSA2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogSA3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogSA4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogISString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogIS1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogIS2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogIS3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogIS4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogPSString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPS1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPS2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPS3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogPS4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogRPString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRP1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRP2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRP3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRP4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    ...
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogOB3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogOB4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogRBString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRB1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRB2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRB3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogRB4 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly string CustomLogMMString = "";
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogMM1 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogMM2 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogMM3 = double.NaN;
    /// <summary>
    /// A custom performance info by the respective controller.
    /// </summary>
    public readonly double CustomLogMM4 = double.NaN;
}
...
public class BundleHandledDatapoint
{
    ...
    /// </summary>
    public readonly int InputStation;
    /// <summary>
    ...
    /// </summary>
    public readonly double TurnoverTime;
    /// <summary>
    /// The time between allocation and handling of the bundle.
    /// </summary>
    public readonly double ThroughputTime;
    /// <summary>
    /// Creates a new datapoint.
    /// </summary>
    ...
    public string GetLine()
    {
        return
            TimeStamp.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
            Bot + IOConstants.DELIMITER_VALUE +
            Pod + IOConstants.DELIMITER_VALUE +
            InputStation + IOConstants.DELIMITER_VALUE +
...
public class ItemHandledDatapoint
{
    ...
    /// </summary>
    public readonly int OutputStation;
    /// <summary>
    /// Creates a new datapoint.
    /// </summary>
    /// <param name="timestamp">The timestamp.</param>
...
public class OrderHandledDatapoint
{
    ...
    /// </summary>
    public readonly double Lateness;
    /// <summary>
    /// Creates a new datapoint.
    /// </summary>
    /// <param name="timestamp">The timestamp.</param>
    ...
    public string GetLine()
    {
        return
            TimeStamp.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
            OutputStation + IOConstants.DELIMITER_VALUE +
            TurnoverTime.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
...
public class BotDatapoint
{
    ...
    /// </summary>
    public readonly double BotsQueueing;
    /// <summary>
    /// The number of bots currently engaging in the given tasks.
    /// </summary>
    public readonly Tuple<string, int>[] TaskBotCounts;
    /// <summary>
    /// Creates a new datapoint.
    /// </summary>
    /// <param name="timestamp">The timestamp.</param>
    ...
    public string GetLine()
    {
        return
            ...
            string.Join(IOConstants.DELIMITER_LIST.ToString(), TaskBotCounts.Select(t =>
                t.Item1 + IOConstants.DELIMITER_TUPLE +
...
public class BundleOrderSituationDatapoint
{
    ...
    public string GetLine()
    {
        return
            TimeStamp.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
            BacklogBundleCount + IOConstants.DELIMITER_VALUE +
            BacklogOrderCount + IOConstants.DELIMITER_VALUE +
...
public class StationDataPoint
{
    ...
    public string GetLine()
    {
        return
            TimeStamp.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
            PodsHandledAtIStations + IOConstants.DELIMITER_VALUE +
            PodsHandledAtOStations + IOConstants.DELIMITER_VALUE +
            ActiveIStations + IOConstants.DELIMITER_VALUE +
            ActiveOStations + IOConstants.DELIMITER_VALUE +
            string.Join(IOConstants.DELIMITER_LIST.ToString(), IStationIdleTimes.Select(t =>
                t.Item1.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_TUPLE +
...
public class PerformanceDatapoint
{
    ...
    /// </summary>
    public readonly Tuple<string, double>[] OverallControllerTimes;
    /// <summary>
    /// Creates a new datapoint.
    /// </summary>
    /// <param name="timestamp">The timestamp.</param>
...
public class LocationDatapoint : HeatDatapoint
{
    ...
    public string ToCSV()
    {
        var task = BotTask switch
        {
            BotTaskType.None => 'N',
            BotTaskType.ParkPod => 'P',
            BotTaskType.RepositionPod => 'R',
            BotTaskType.Insert => 'I',
            BotTaskType.Extract => 'E',
            BotTaskType.Rest => 'S',
            _ => throw new ArgumentException("Unknown bot task type: " + BotTask)
        };
        return
            TimeStamp.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER) + IOConstants.DELIMITER_VALUE +
            Tier + IOConstants.DELIMITER_VALUE +
    ...
    {
        var values = csvLine.Split(IOConstants.DELIMITER_VALUE);
        var task = values[4][0] switch
        {
            'N' => BotTaskType.None,
            'P' => BotTaskType.ParkPod,
            'R' => BotTaskType.RepositionPod,
            'I' => BotTaskType.Insert,
            'E' => BotTaskType.Extract,
            'S' => BotTaskType.Rest,
            _ => throw new ArgumentException("Unknown bot task type: " + values[4])
        };
...
public class TimeIndependentTripDataPoint : HeatDatapoint
{
    ...
    {
        var dataType = Enum.GetValues(typeof(TripDataType)).Cast<TripDataType>().ElementAt(dataIndex);
        return dataType switch
        {
            TripDataType.Overall => Overall,
            TripDataType.FromOStation => FromOStation,
            TripDataType.ToOStation => ToOStation,
            TripDataType.FromIStation => FromIStation,
            TripDataType.ToIStation => ToIStation,
...
public class StorageLocationInfoDatapoint : HeatDatapoint
{
    ...
    public override double GetValue(int dataIndex)
    {
        var dataType = Enum.GetValues(typeof(StorageLocationInfoType)).Cast<StorageLocationInfoType>().ElementAt(dataIndex);
        return dataType switch
        {
            StorageLocationInfoType.Speed => Speed,
            StorageLocationInfoType.Utility => Utility,
            StorageLocationInfoType.Combined => Combined,
            _ => throw new ArgumentException("Unknown data-type: " + dataType)
        };
    }
}
