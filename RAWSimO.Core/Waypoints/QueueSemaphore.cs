...
public class QueueSemaphore : InstanceElement, ISemaphoreInfo
{
    ...
    /// </summary>
    private readonly HashSet<Bot> _bots = [];

    /// <summary>
    /// All entrances and exits of this area.
    /// </summary>
    private readonly HashSet<QueueGuard> _guards = [];

    /// <summary>
    /// All entrances and exits of this area.
    /// </summary>
    public IEnumerable<QueueGuard> Guards => _guards;
    ...
    {
        var guard = new QueueGuard(from, to, entry, barrier, this);
        _guards.Add(guard);
    ...
    /// </summary>
    public bool IsAccessible => Requests < Capacity;
    ...
    public override string GetIdentfierString() { return "Semaphore" + ID; }
    /// <summary>
    /// Returns a simple string giving information about the object.
    /// </summary>
    /// <returns>A simple string.</returns>
    public override string ToString() { return "Semaphore" + ID; }
