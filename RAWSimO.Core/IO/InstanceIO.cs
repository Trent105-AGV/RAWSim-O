...
public class InstanceIO
{
    ...
    private static readonly XmlSerializer
        SettingConfigSerializer = new(typeof(SettingConfiguration));

    private static readonly XmlSerializer
        ControlConfigSerializer = new(typeof(ControlConfiguration));

    private static readonly XmlSerializer ListSerializer = new(typeof(DTOOrderList));
