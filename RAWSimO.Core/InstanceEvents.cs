...
public partial class Instance
{
    ...
    internal void NotifyBundlePlaced(ItemBundle bundle)
    {
        ...
        if (bundle != null)
        {
            ...
            _statBundlePlacementTimestamps.Add(new BundlePlacedDatapoint(Controller == null ? 0 : StatTime));
            // Flush data points in case there are too many already
    ...
    internal void NotifyOrderPlaced(Order order)
    {
        ...
        if (order != null)
        {
            ...
            _statOrderPlacementTimestamps.Add(new OrderPlacedDatapoint(Controller == null ? 0 : StatTime));
            // Flush data points in case there are too many already
