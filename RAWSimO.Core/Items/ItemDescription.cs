...
public abstract class ItemDescription : InstanceElement, IItemDescriptionInfo, IExposeVolatileID
{
    ...
    /// </summary>
    public int OrderCount => Instance.FrequencyTracker.GetModifiableOrderCount(this);
    ...
    public override string GetIdentfierString() { return "ItemDescription" + ID; }
    /// <summary>
    /// Returns a simple string giving information about the object.
    /// </summary>
    /// <returns>A simple string.</returns>
    public override string ToString() { return "ItemDescription" + ID; }
