...
public class Order : IOrderInfo
{
    ...
    /// </summary>
    private int _overallQuantity;
    /// <summary>
    /// The quantities needed per order line.
    /// </summary>
    private readonly Dictionary<ItemDescription, int> _quantities = new();
    /// <summary>
    /// The requests belonging to the order lines.
    /// </summary>
    private readonly Dictionary<ItemDescription, HashSet<ExtractRequest>> _requests = new();
    /// <summary>
    /// The overall served demand quantity.
    /// </summary>
    private int _overallServedQuantity;
    /// <summary>
    /// The quantities already fulfilled per order line.
    /// </summary>
    private readonly Dictionary<ItemDescription, int> _servedQuantities = new();
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<KeyValuePair<ItemDescription, int>> Positions => _quantities;
    ...
    { if (!_requests.ContainsKey(itemDescription)) _requests[itemDescription] = []; _requests[itemDescription].Add(request); }
    /// <summary>
