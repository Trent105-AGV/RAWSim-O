...
public class OrderList
{
    ...
    internal OrderList(ItemType type) { Type = type; ItemDescriptions = []; Orders = []; Bundles = []; }
    ...
    public string GetMetaInfoBasedOrderListName()
    {
        ...
        return
            Type + delimiter +
            ItemDescriptions.Count + delimiter +
            Bundles.Count + delimiter +
            Orders.Count + delimiter +
